...
public class TestA1BasicUIX071 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        elements.add(com.google.android.material.radiobutton.MaterialRadioButton.class); //Element 1
        elements.add(com.google.android.material.radiobutton.MaterialRadioButton.class); //Element 2
        elements.add(com.google.android.material.radiobutton.MaterialRadioButton.class); //Element 3
        /************************/
