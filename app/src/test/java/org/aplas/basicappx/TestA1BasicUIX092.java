...
public class TestA1BasicUIX092 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        int colSize = 4;
        elements.clear();
        for (int i=0;i<4;i++) elements.add(com.google.android.material.textview.MaterialTextView.class);
    ...
    public double convert(String oriUnit, String convUnit, double value){
        if (oriUnit.equals("C")){  // dari Cel ke Far atau Kelv
        ...
        }else if(oriUnit.equals("F")){ // dari Far ke Cel atau kelv
